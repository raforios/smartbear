 ...
 *
 * Reads the AUTH base URLs from data/config.json (same file the public
 * portal uses), wires the form, and redirects to the admin shell on
 * success. Errors are surfaced inline.
 */
