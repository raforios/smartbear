...
async def lifespan(_: FastAPI) -> AsyncIterator[None]:
    ...
    '''
    message = 'AI startup: interpretation service ready.'
    logger.info(message)
    yield
    message = 'AI shutdown: closing resources.'
    logger.info(message)


APP_CONFIG = {
    'root_path': ROOT_PATH_NORMALIZED,
    'title': 'AI Interpretation Service',
    'description': (
        'SmartDecisions interpretation layer. Every other service answers '
        'with data and stable codes; this one turns what a screen is showing '
        'into words, written from the point of view of the expert configured '
        'for that view. It explains what it is given: no database access, no '
        'actions, and no figure that is not already on the screen.'
    ),
    'version': '1.0.0',
    'contact': {
        'name': 'API Support',
