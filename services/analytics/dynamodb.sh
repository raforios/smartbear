...
# Local DynamoDB management script for the Analytics service.
# Provisions the t_analytics_runs table required by the API.
...
# Composite key: dataset_id (HASH) + run_id (RANGE). A single dataset can have
# multiple runs (e.g., re-tuned thresholds); the sort key keeps the history.
TABLES=(
    '{ "name": "t_analytics_runs", "attributes": "AttributeName=dataset_id,AttributeType=S AttributeName=run_id,AttributeType=S", "keys": "AttributeName=dataset_id,KeyType=HASH AttributeName=run_id,KeyType=RANGE" }'
)

echo "==================================================="
echo "  Analytics - DynamoDB Local Bootstrap"
echo "==================================================="
echo ""
...
echo "==================================================="
echo "  Analytics DynamoDB bootstrap complete."
echo "==================================================="
