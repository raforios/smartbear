...
manage_security_groups() {
    ...
    # Nota: Las reglas Ingress se gestionan en el script 'configure_security_groups.sh'.
    echo "Las reglas Ingress se gestionarán en el script 'configure_security_groups.sh' (Paso 1.5)."
