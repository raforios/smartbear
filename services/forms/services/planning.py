...
async def create_planning_with_details(
    ...
    '''
        Creates a planning record and its nested details
    ...
    # 2. Iterate through planning details to create nested records.
...
async def update_planning_with_details(
    ...
    '''
        ...
        Note: This function does not handle updates for details.
    '''
