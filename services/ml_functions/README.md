...
* **Regresión Lineal (Simple y Múltiple):** Para entrenar modelos y predecir valores continuos.
...
| :--- | :--- | :--- |
| `POST` | `/v1/prediction/compute-cost-single-feature` | Calcula el costo para regresión lineal de una sola característica. |
| `POST` | `/v1/prediction/compute-gradient-single-feature` | Calcula el gradiente para regresión lineal de una sola característica. |
| `POST` | `/v1/prediction/train-single-linear-regression` | Entrena un modelo de regresión lineal de una sola característica. |
| `POST` | `/v1/prediction/compute-cost` | Calcula el costo para regresión lineal multicaracterística (operaciones de matriz). |
| `POST` | `/v1/prediction/compute-gradient` | Calcula el gradiente para regresión lineal multicaracterística (operaciones de matriz). |
| `POST` | `/v1/prediction/train-linear-regression` | Entrena un modelo de regresión lineal multicaracterística (operaciones de matriz). |
...
| Método | Endpoint | Descripción |
| :--- | :--- | :--- |
| `GET` | `/v1/classification/sigmoid/{z_value}` | Calcula la función sigmoide para un valor escalar. |
| `POST` | `/v1/classification/sigmoid-batch` | Calcula la función sigmoide para una lista de valores. |
| `POST` | `/v1/classification/compute-cost-logistic` | Calcula el costo para regresión logística. |
| `POST` | `/v1/classification/compute-gradient-logistic` | Calcula el gradiente para regresión logística. |
| `POST` | `/v1/classification/gradient-descent-logistic` | Realiza el descenso de gradiente para entrenar un modelo de regresión logística. |
| `POST` | `/v1/classification/predict-classification` | Realiza una clasificación (0 o 1) con un modelo entrenado. |
