...
# Local DynamoDB management script for the Optimization service.
# Provisions the t_optimization_routes table required by the API.
...
# Composite key: route_day_key (HASH) + client_id (RANGE).
TABLES=(
    '{ "name": "t_optimization_routes", "attributes": "AttributeName=route_day_key,AttributeType=S AttributeName=client_id,AttributeType=N", "keys": "AttributeName=route_day_key,KeyType=HASH AttributeName=client_id,KeyType=RANGE" }'
)

echo "==================================================="
echo "  Optimization - DynamoDB Local Bootstrap"
echo "==================================================="
echo ""
...
echo "==================================================="
echo "  Optimization DynamoDB bootstrap complete."
echo "==================================================="
