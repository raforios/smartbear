...
#
# Usage:
#   chmod +x tools/optimization/recreate_aws_table.sh
#   AWS_PROFILE=deploy_ml ./tools/optimization/recreate_aws_table.sh
#
...
echo "  PYTHONPATH=services/optimization python tools/optimization/seed_from_csv.py --csv tools/optimization/sample_routes.csv"
